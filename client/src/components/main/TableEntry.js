...
const TableEntry = (props) => {
    ...
    const assignedStyle = data.completed ? ' assign-complete-task' : ' assign-incomplete-task';
        ...
        <WRow className='table-entry'>
            ...
            <WCol size="2">
            {
                    editingAssigned || assigned_to === ''
                        ...
                        />
                        : <div 
                            onClick={() => toggleAssignedEdit(!editingAssigned)} className={`${assignedStyle} table-text`}
                        >{assigned_to}
                        </div>
                }
            </WCol>
            ...
            <WCol size="2">
                <div className='button-group'>
                    <WButton className="table-entry-buttons" disabled={props.disableUp} onClick={() => props.reorderItem(data._id, -1)} wType="texted">
                        <i className="material-icons">expand_less</i>
                    </WButton>
                    <WButton className="table-entry-buttons" disabled={props.disableDown} onClick={() => props.reorderItem(data._id, 1)} wType="texted">
